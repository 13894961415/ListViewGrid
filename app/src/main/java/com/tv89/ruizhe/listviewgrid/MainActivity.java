package com.tv89.ruizhe.listviewgrid;
...
import com.tv89.ruizhe.listviewgrid.adapter.ListViewAdapter;

public class MainActivity extends Activity implements ListViewAdapter.MyClickListener {
    ...
    private void init() {
        ...
        mLAdapter = new ListViewAdapter(mData, MainActivity.this,this);
